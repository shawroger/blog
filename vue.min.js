...
!(function (e, t) {
			...
			prepatch: function (t, n) {
				...
				!(function (t, n, r, i, o) {
					...
					(t.$options._parentListeners = r),
						Jt(t, r, h),
						u && ((t.$slots = ct(o, i.context)), t.$forceUpdate());
				})(
	...
	!(function (e) {
		...
		Object.defineProperty(e, "config", t),
			(e.util = { warn: oe, extend: k, mergeOptions: je, defineReactive: xe }),
			(e.set = Ce),
			(e.delete = Ae),
			(e.nextTick = Xe),
							  ...
							  (function (e, r, i, o, a) {
									for (
										...
										t(h)
											...
											? (m = r[--v])
											: nr(h, g)
											? (C(h, g, o, i, d), (h = r[++p]), (g = i[++d]))
											: nr(m, b)
											? (C(m, b, o, i, y), (m = r[--v]), (b = i[--y]))
											: nr(h, b)
											? (C(h, b, o, i, y),
									...
									a.sync &&
										...
										c
											...
											: (Lr(e, "update:" + b(r), s, null, !1, 0, u[t]),
											  x(r) !== b(r) &&
													Lr(e, "update:" + x(r), s, null, !1, 0, u[t])))),
